 ...
 */
static void
binder_enqueue_work_head_ilocked(struct binder_work *work,struct list_head *target_list)
{
	BUG_ON(target_list == NULL);
	BUG_ON(work->entry.next && !list_empty(&work->entry));
 ...
 */
static void
binder_enqueue_thread_work_head_ilocked(struct binder_thread *thread,struct binder_work *work)
{
 ...
 */
static void
binder_enqueue_thread_work_head(struct binder_thread *thread,struct binder_work *work)
{
	binder_inner_proc_lock(thread->proc);
